...
class settings:
    ...
    TABLES = [
        {"name": "旅游景点爬虫数据", "db": "travel", "table": "travel", "db_num": 0, "t_num": 0,
         'hive_db': 'dwd_travel', 'hive_table': 'dwd_travel_db_spider_t_travel', "update_column": "publishtime"},
        {"name": "热门景点TOP20", "db": "travel", "table": "hot_TOP20", "db_num": 0, "t_num": 0,
         'hive_db': 'ads_travel', 'hive_table': 'ads_travel_db_travel_t_hottravel_TOP20', "update_column":None},
    ]
