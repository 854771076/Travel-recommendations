...
class settings:
    ...
    TABLES = [
        ...
        {"name": "旅游景点爬虫数据", "db": "spider", "table": "travel", "db_num": 0, "t_num": 0,
         'hive_db': 'ods_travel', 'hive_table': 'ods_travel_db_spider_t_travel', "update_column": "create_time"},
        {"name": "用户简历信息", "db": "travel", "table": "resume", "db_num": 0, "t_num": 0,
         'hive_db': 'ods_travel', 'hive_table': 'ods_travel_db_travel_t_resume', "update_column": "last_update"},
        {"name": "用户点击浏览职位", "db": "travel", "table": "click", "db_num": 0, "t_num": 0,
         'hive_db': 'ods_travel', 'hive_table': 'ods_travel_db_travel_t_clicktravel', "update_column": "last_update"},
        {"name": "用户收藏职位", "db": "travel", "table": "star", "db_num": 0, "t_num": 0,
         'hive_db': 'ods_travel', 'hive_table': 'ods_travel_db_travel_t_startravel', "update_column": "create_time"},
    ]
