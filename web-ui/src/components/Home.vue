        ...
        <el-container>
            <el-header class="navbar-wrapper">
                <el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" :ellipsis="false" :router="true">
                    ...
                    <el-menu-item index="/travel" class="min_hide">找景点</el-menu-item>
            ...
            <div class="phone-tabbar">
                <el-menu :default-active="activeIndex" class="el-menu" mode="horizontal" :ellipsis="false" :router="true">
                    ...
                    <el-menu-item index="/travel"><div class="phone-tabbar-item"><el-icon><Suitcase /></el-icon><div>找景点</div> </div></el-menu-item>
