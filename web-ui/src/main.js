...
app.config.globalProperties.$api = {
    ...
    travel:'/api/data/travel/',
    similartravel:'/api/data/similar/',
    click:'/api/data/travel/click/',
    collect:'/api/data/travel/collect/',
    iscollected:'/api/data/travel/iscollected/',
    removecollect:'/api/data/travel/removecollect/',
    recommend:'/api/data/travel/recommend/',
    collecttravel:'/api/data/travel/collectTravel/',
    clicktravel:'/api/data/travel/clickTravel/',
    guihua:'/api/data/travel/guihua/',
    comment:'/api/data/travel/comment/',
    commenttravel:'/api/data/travel/commentTravel/',
}
